...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" media="print" href="css/csspr.css" />
            ...
            <div id="phrase">
                ...
                <p class="txt" id="maitre2">
                    <select name="fonction">
                        ...
                        <OPTION VALUE="la sainte Vierge">la sainte Vierge</OPTION>
            ...
            <div id="appli">
                ...
                <div id="choix">
                    ...
                    <div class="liste" id="listecouleur">
                        <div class="color aucun" id="aucun"></div>
                        <div class="color" Style="background-image: url('images/couleurs/tapjaune.png');" id="tapjaune"></div>
                        ...
                        <div class="color" Style="background-image: url('images/couleurs/taprovio.png');" id="taprovio"></div>
                        <div class="color" Style="background-image: url('images/couleurs/tapbleu.png');" id="tapbleu"></div>
                        <div class="color" Style="background-image: url('images/couleurs/tapciel.png');" id="tapciel"></div>
                    </div>
                    <a id="sculptures" class="button" href="#">Choisissez 1 à 3 sculptures</a>
                    <div id="boxsculpt">
                        <div id="position">
                            <p class="button">Position</p>
                        ...
                        <div class="liste listesculpt">
                            <div>
                                <img src="images/miniatures/F1-8-sainte-Vierge.png" alt="F1-8-sainte-Vierge.png" class="scul preview first"/>
                                <img src="images/miniatures/F1-9-saint-Georges.png" alt="F1-9-saint-Georges.png" class="scul preview"/>
                                <img src="images/miniatures/F1-10-saint-Michel.png" alt="F1-10-saint-Michel.png" class="scul preview"/>

                                <img src="images/miniatures/F1-11-sainte-Marie-Madeleine.png" alt="F1-11-sainte-Marie-Madeleine.png" class="scul preview"/>
                                <img src="images/miniatures/GS1-2-saint-diacre.png" alt="GS1-2-saint-diacre.png" class="scul preview"/>
                                <img src="images/miniatures/GS1-6-saint-Léonard.png" alt="GS1-6-saint-Léonard.png" class="scul preview"/>

                                <img src="images/miniatures/GS1-6-saint-Wendelin.png" alt="GS1-6-saint-Wendelin.png" class="scul preview"/>
                                <img src="images/miniatures/GS1-7sainte-Vierge.png" alt="GS1-7sainte-Vierge.png" class="scul preview"/>
                                <img src="images/miniatures/GS4-10-saint-Eloi.png" alt="GS4-10-saint-Eloi.png" class="scul preview"/>

                                <img src="images/miniatures/GS4-14-saint-Ulrich.png" alt="GS4-14-saint-Ulrich.png" class="scul preview last"/>
                            </div>
                        </div>
